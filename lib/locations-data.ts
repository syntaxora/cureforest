...
export const locationPrograms: LocationProgram[] = [
  {
    ...
    number: "01",
    title: "호수공원 치유",
    subtitle: "Lake Park Healing",
    icon: MapPin,
    image: "/images/dongtan-healing-1.jpg",
    shortDescription: "자연이 주는 평온함 속에서 몸과 마음의 쉼을 경험하세요.",
    ...
    tagline: "몸, 마음 알아차림. 이완. 힐링.",
    secondaryTagline: "자연이 주는 평온함 속에서 몸과 마음의 쉼을 경험하세요.",
    galleryImages: ["/images/dongtan-healing-1.jpg", "/images/dongtan-healing-2.jpg"],
    features: [
      "도심 속 자연 힐링 공간",
      "아름다운 호수 전망",
      "잘 정비된 산책로",
  ...
  },
  {
    ...
    number: "02",
    title: "호수공원 생태 프로그램",
    subtitle: "Lake Park Ecology Program",
    icon: Trees,
    image: "/images/dongtan-ecology-1.jpg",
    shortDescription: "자연은 아이들의 친구이자 최고의 놀이터입니다.",
    ...
    tagline: "자연속에서 배우고 느끼고 성장하다.",
    secondaryTagline: "자연은 아이들의 친구이자 최고의 놀이터입니다.",
    galleryImages: ["/images/dongtan-ecology-1.jpg", "/images/dongtan-ecology-2.jpg"],
    features: [
      "전문 생태해설사 동행",
      "다양한 동식물 관찰",
      "체험 중심 교육",
  ...
  },
  {
    ...
    number: "03",
    title: "다올공원 온뜰정원",
    subtitle: "Daol Park Garden",
    icon: Flower2,
    image: "/images/daol-garden-1.jpg",
    shortDescription: "정원에서 몸과 마음을 가꿉니다. 꽃과 식물이 전하는 따뜻한 치유",
    ...
    tagline: "정원 속 마음산책",
    secondaryTagline: "정원에서 몸과 마음을 가꿉니다. 꽃과 식물이 전하는 따뜻한 치유",
    galleryImages: ["/images/daol-garden-1.jpg", "/images/daol-garden-2.jpg"],
    features: [
      "전문 원예치료사 진행",
      "다양한 식물 체험",
      "작품 가져가기 가능",
  ...
  },
  {
    ...
    number: "04",
    title: "무봉산 숲치유",
    subtitle: "Mubongsan Forest Healing",
    icon: Mountain,
    image: "/images/mubongsan-1.jpg",
    shortDescription: "나무. 바람. 햇살과 함께하는 특별한 치유여행",
    ...
    capacity: "최소 8명 ~ 최대 20명",
    tagline: "호흡과 숲명상. 차한잔으로 만나는 온기 쉼",
    secondaryTagline: "나무. 바람. 햇살과 함께하는 특별한 치유여행",
    galleryImages: ["/images/mubongsan-1.jpg", "/images/mubongsan-2.jpg"],
    features: [
      "깊은 산림 환경",
      "피톤치드 풍부",
      "맑은 계곡",
  ...
  },
  {
    ...
    icon: TreePine,
    image: "/images/hwaseong-forest-1.jpg",
    ...
    price: "프로그램별 상이 (문의)",
    capacity: "최소 10명 ~ 최대 25명",
    tagline: "숲과 함께하는 자연 이야기",
    secondaryTagline: "화성시 일대의 숲에서 진행되는 전문 숲해설 프로그램입니다.",
    galleryImages: ["/images/hwaseong-forest-1.jpg", "/images/hwaseong-forest-2.jpg"],
    features: [
      "전문 숲해설가 동행",
      "다양한 장소 선택 가능",
      "맞춤형 프로그램 가능",
...
export function getLocationBySlug(slug: string): LocationProgram | null {
